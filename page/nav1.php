...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="a.php">عروض التكوين</a></li>
            <li class="nav-item"><a class="nav-link" href="4.php">من نحن</a></li>
            <li class="nav-item"><a class="nav-link" href="4.php">اتصل بنا</a></li>
        </ul>
    </div>
</nav>
</body>
